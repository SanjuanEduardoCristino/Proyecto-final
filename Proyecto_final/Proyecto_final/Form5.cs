...
namespace Proyecto_final
{
    public partial class Form5 : Form
    {
        ...
        private void buscar()
        {
            ...
            string query = "SELECT * FROM sales where id='" + textBox4.Text + "' ";
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventario";
            string query = "INSERT INTO sales(`ID`, `Name`, `Quantity`, `Cost`) VALUES (NULL, '" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "')";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventario";
            string query = "DELETE FROM sales WHERE id='" + textBox4.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
        ...
        {
            string connection = "datasource=localhost;port=3306;username=root;password=;database=inventario";
            string query = "UPDATE sales SET Name='" + textBox1.Text + "',Quantity='" + textBox2.Text + "',Cost='" + textBox3.Text + "' WHERE id='" + textBox4.Text + "' ";
            MySqlConnection conectionDatabase = new MySqlConnection(connection);
            MySqlCommand databaseCommand = new MySqlCommand(query, conectionDatabase);
            databaseCommand.CommandTimeout = 60;
